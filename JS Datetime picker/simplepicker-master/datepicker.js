var SimplePicker = (function (e) {
    ...
    "0DyV": function (e, t, i) {
        ...
        function r(e) {
            ...
            if (((t.monthTracker.current = new Date(e.getTime())), t.monthTracker.current.setDate(1), (t.monthTracker.years[r] = t.monthTracker.years[r] || {}), void 0 !== t.monthTracker.years[r][s]))
        ...
        var s = { st: [1, 21, 31], nd: [2, 22], rd: [3, 23] };
                ...
                return (
                    ...
                    (e.prototype.init = function (e, t) {
                        ...
                        (this.$simplepicker = i(".simpilepicker-date-picker")),
                            ...
                            (this.opts = t),
                            this.reset(s),
                            void 0 !== t.zIndex && (this.$simplepickerWrapper.style.zIndex = t.zIndex.toString()),
                    ...
                    (e.prototype.handleIconButtonClick = function (e) {
                        ...
                        if (
                            (o && (t = o.innerHTML.trim()), e.classList.contains("simplepicker-icon-next") && this.render(n.scrapeNextMonth()), e.classList.contains("simplepicker-icon-previous") && this.render(n.scrapePreviousMonth()), t)
                        ) {
